...
//     ---------------------- uniform ----------------------------------
   	model = new Model (threshold, confidence, knn, ESTIMATOR::Affine, SAMPLER::Uniform);
//     --------------------------------------------------------------

//     ---------------------- napsac ----------------------------------
//    model = new Model (threshold, confidence, knn, ESTIMATOR::Affine, SAMPLER::Napsac);
//     --------------------------------------------------------------

// ------------------ prosac ---------------------
//     model = new Model (threshold, confidence, knn, ESTIMATOR::Affine, SAMPLER::Prosac);
//     -------------------------------------------------
